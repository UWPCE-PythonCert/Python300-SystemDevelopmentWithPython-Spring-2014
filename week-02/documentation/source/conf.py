...
# sphinx-quickstart on Tue Mar 25 16:19:30 2014.
#
...
latex_documents = [
  ('Documentation', 'Documentation.tex', u'Documentation Documentation',
...
man_pages = [
    ('Documentation', 'documentation', u'Documentation Documentation',
     [u'Chris Barker'], 1)
]
...
texinfo_documents = [
  ('Documentation', 'Documentation', u'Documentation Documentation',
   u'Chris Barker', 'Documentation', 'One line description of project.',
   'Miscellaneous'),
]
